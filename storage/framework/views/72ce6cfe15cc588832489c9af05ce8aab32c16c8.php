...
<div class="container">
    ...
    <div class="row margin-top-20">
        ...
        <div class="col-md-6">
            ...
            <label><input class="gg" type="checkbox" name="category[]" value="Red"> Red</label>
            <label><input class="gg" type="checkbox" name="category[]" value="Blue"> Blue</label>
            <label><input class="gg" type="checkbox" name="category[]" value="Green"> Green</label>
            <label><input class="gg" type="checkbox" name="category[]" value="Yellow">
                Yellow</label>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).on("click", ".keywords, .users, .time-range", function() {
        var keywords = [];
...
<?php /**PATH F:\xampp\htdocs\SearchEngineLaravel\resources\views/layouts/frontend/include/userSearchHistory.blade.php ENDPATH**/ ?>